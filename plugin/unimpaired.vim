...
call s:map('n', '[om', ':setlocal conceallevel=2<CR>')
call s:map('n', ']om', ':setlocal conceallevel=0<CR>')
call s:map('n', 'yom', ':setlocal conceallevel=<C-R>=&conceallevel ? 0 : 2<CR><CR>')
call s:map('n', '[oh', ':set hlsearch<CR>')
call s:map('n', ']oh', ':nohlsearch<CR>')
call s:map('n', 'yoh', ':<C-R>=v:hlsearch ? "nohlsearch" : "set hlsearch"<CR><CR>')
